...
**[Download nav.vim](https://raw.github.com/q335r49/textabyss/master/nav.vim)**, open vim, and type: <samp>source [download directory]/nav.vim</samp>.

Navigate to the **working directory** to be associated with the plane (you only need to do this to you create a plane). Press `F10` to bring up a prompt for files. You can try a pattern like <samp>*.txt</samp>, or you can name a single file and append others as needed.
...
Lines of the above form are considered labels. `R`edraw will:  
